...
```bash
python3 /path/to/claude-handoff/scripts/apply_marker_block.py --file <CODEX.md-or-CLAUDE.md> --block-file /tmp/handoff-rule.md
```
...
- Also create a dated backup in the same lane (`.handoff/YYYY-MM-DD-HHMMSS-claude.md`, or `.handoff/scopes/<scope>/YYYY-MM-DD-HHMMSS-claude.md`) without overwriting existing backups.
